...
import 'NewVideoIn.dart';



class InstructorList extends StatefulWidget {
  const InstructorList({Key? key,required this.new1I}) : super(key: key);

  final course_class new1I;
  @override
...
class _InstructorListState extends State<InstructorList> {
  ...
  static List<courseVideosIn> _InstructorListv = [
    /*  course_class(
      courseName:
        'python',
        courseCode:
  ...
  void _addNewCYt(String course, String namein){
    final newIn= courseVideosIn(
      videoTitle: course,
      name: namein,
      courseCode:widget.new1I.courseCode,

    );
    setState(() {
      _InstructorListv.add(newIn);
    });
  }
                ...
                child: Column(
                  children:[
                    ...
                    Container(
                      ...
                      height: 600,
                      child: ListView(children:_InstructorListv.where((element) => element.courseCode == widget.new1I.courseCode).map((tx){
                        return Column(
                          children:[
                            Container(
                                height:230,
                                        ...
                                        children:[
                                          ...
                                          Container(width:300, height:50,
                                              decoration:BoxDecoration(
                                                borderRadius: BorderRadius.circular(5),
                                                gradient: LinearGradient(colors: [Colors.deepPurple.shade200, Colors.deepPurpleAccent],),),
                                              child:Center(child: Text('Instructor: ${tx.name}'))),
                                          FlatButton(
